...
namespace DatabaseConnection.Migrations
{
    ...
    [Migration("20201202120206_GenresTest")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenreMovie", b =>
                {
                    b.Property<int>("GenresTestId")
                        .HasColumnType("int");

                    b.Property<int>("MoviesTestId")
                        .HasColumnType("int");

                    b.HasKey("GenresTestId", "MoviesTestId");

                    b.HasIndex("MoviesTestId");
            ...
            modelBuilder.Entity("GenreMovie", b =>
                {
                    b.HasOne("DatabaseConnection.Genre", null)
                        .WithMany()
                        .HasForeignKey("GenresTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DatabaseConnection.Movie", null)
                        .WithMany()
                        .HasForeignKey("MoviesTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
